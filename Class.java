...
public class Class {
    public static void main(String[] args) {
        ...
        Customers.total.add(0); // Initialize the initial values for cashiers
        Customers.total.add(0);
        Customers.total.add(0);
            ...
            while (isRunning) {
                ...
                switch (function) {
                    ...
                    case "PCQ":
                        ...
                        String name_serve = inp.nextLine();
                        Customers.served(name_serve,food.customers,food.burghers);
